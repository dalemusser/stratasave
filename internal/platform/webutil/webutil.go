// internal/platform/webutil/webutil.go
package webutil
...
//	safeRedirect := webutil.SafeReturn(ret, deletedID, "/admin/items")
...
// IsValidAbsHTTPURL validates that a string is a well-formed absolute HTTP(S) URL.
//
// A valid URL must:
